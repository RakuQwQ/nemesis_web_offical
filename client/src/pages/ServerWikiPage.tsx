...
export default function ServerWikiPage() {
  useSeo({
    title: '伺服器百科',
    description: `香港 Minecraft 伺服器目錄，共收錄 ${servers.length} 個伺服器，包括生存、UHC、SMP 等類型。NEMESIS 公會精選推薦。`,
    canonical: '/server-wiki',
    keywords: '香港 Minecraft 伺服器, 香港 Minecraft 伺服器目錄, Minecraft SMP 香港, Minecraft UHC 香港, 生存伺服器, 香港伺服器推薦',
  });
