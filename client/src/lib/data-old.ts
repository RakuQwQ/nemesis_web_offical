...
//
// Notes
//   • For NEMI server *news* (blog-style records), edit the markdown
//     files in src/lib/nemi-news/ instead. News are NOT events and
//     are not listed here.
//   • Events tagged with 'nemi' will appear in the 伺服器活動 section
//     of the NEMI 生存伺服器 page.
//
